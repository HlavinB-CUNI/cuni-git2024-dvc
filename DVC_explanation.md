...
Why should someone not only use Git? 
	- Well with Git, while it is useful to use for code files, Git struggles with quickly adding and synchronizing database 
	  and other large quantities of variables of information. 
	 
	- Historically, trying to move or deal with large quanitites of data in git alone has been met with adversity or crashing.
